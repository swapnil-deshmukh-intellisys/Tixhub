CREATE TABLE IF NOT EXISTS hotels (
  ...
  status ENUM('draft','active','inactive','hidden') NOT NULL DEFAULT 'active',
...
CREATE TABLE IF NOT EXISTS hotel_rooms (
  ...
  weekday_price DECIMAL(12,2) NOT NULL DEFAULT 0,
  weekend_price DECIMAL(12,2) NOT NULL DEFAULT 0,
  seasonal_price DECIMAL(12,2) NOT NULL DEFAULT 0,
  extra_adult_charge DECIMAL(12,2) NOT NULL DEFAULT 0,
  extra_child_charge DECIMAL(12,2) NOT NULL DEFAULT 0,
