...
function MovieVendorModule({
  ...
  const summary = useMemo(() => {
    ...
    return {
      ...
      bookedSeats,
      movieBookings:
        movieBookings.length || toNumber(stats.movieBookings || stats.totalBookings),
      movieRevenue,
      occupancy,
    };
    ...
    <>
      <section className="movie-vendor-hero">
        <div className="movie-vendor-hero-left">
          ...
          <div>
            <h1>Movie Vendor Dashboard</h1>
            <p>
              Manage movies, theatres, shows, seats, bookings, QR scans, and revenue.
            </p>
          </div>
        </div>
                ...
                {upcomingShows.length ? (
                  upcomingShows.map((movie, index) => {
                    ...
                    const availableSeats = Math.max(
                      totalSeats - bookedSeats - blockedSeats,
                      0
                    );
      ...
      <section className="vendor-panel vendor-page-panel movie-list-panel">
        <div className="movie-list-panel-header">
          <h2>My Movies</h2>

          <label className="movie-calendar-button">
